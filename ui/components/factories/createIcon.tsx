import { DynamicColor } from '@/ui/hooks/useThemeColors'
import { IconSizeTokens } from '@/ui/theme/tokens'
...
export function createIcon({
  ...
  const Icon = forwardRef<Svg, GeneratedIconProps>(({ color, hoverColor: hoverColorProp, ...propsIn }, ref) => {
    ...
    const flattenedStyle = isWeb && Array.isArray(style) ? Object.assign({}, ...style) : style
  ...
  const IconPlain = forwardRef<Svg, IconProps>((props, ref) => {
    ...
    const flatStyle = isWeb && Array.isArray(style) ? Object.assign({}, ...style) : style
