...
export function ElementAfterText({ element, text, wrapperProps, textProps }: ElementAfterTextProps): JSX.Element {
  ...
  if (isWebAppDesktop) {
    return (
      <Flex row items="center" {...wrapperProps}>
    ...
    return (
      <Flex row items="center" pr={postTextElementPositionProps ? '$xl' : undefined} {...wrapperProps}>
