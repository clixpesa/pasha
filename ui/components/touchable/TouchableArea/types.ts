...
import type { TouchableAreaFrame } from './TouchableAreaFrame'
...
type NonRaisedProps = TouchableAreaExtraProps &
  Omit<TouchableAreaFrameProps, 'variant' | 'bg'> & {
    ...
    backgroundColor?: TouchableAreaFrameProps['bg']
  }
...
type RaisedProps = TouchableAreaExtraProps &
  Omit<TouchableAreaFrameProps, 'variant' | 'bg'> & {
    ...
    backgroundColor: NonNullable<TouchableAreaFrameProps['bg']>
  }
